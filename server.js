...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/mongoose-news";
...
app.get("/scrape", function (req, res) {
  ...
  axios.get("https://www.nytimes.com/section/us").then(function (response) {
    ...
    $("article h2").each(function (i, element) {
      ...
      //     .children("section")
      // .attr("id","stream-panel")
      result.link = $(this)
        .children("a")
        .attr("href");

      result.photos = $(this)
        .parent().parent().children("figure")
    ...
    // Go back to homepage after scrape
    res.redirect('/')
  });
});
...
app.post("/articles/:id", function (req, res) {
  ...
  db.Note.create(req.body)
    .then(function (dbNote) {
      ...
      // return db.Article.findOne({ "_id": req.params.id }, { note: dbNote._id }, { new: true })
